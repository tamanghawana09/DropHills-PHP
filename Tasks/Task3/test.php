...
$index = new Index();
$index->connect(); // Establish database connection

if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $index->validation();
}

$index->close(); // Close database connection
?>
...
<body>
    <div class="container">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
            ...
            <span class="error">* <?php echo $index->emailErr;?></span>
            <input type="password" name="password" placeholder="Enter password">
            <span class="error">* <?php echo $index->passwordErr;?></span>
